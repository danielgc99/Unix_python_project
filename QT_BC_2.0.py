...
def generate_all_candidate_clusters(point_data, distance_matrix, threshold):
    ...
    for center_idx in range(len(point_data)):
        ...
        available_points = [i for i in range(len(point_data)) if i != center_idx] #NO QUEREMOS USED SET AQUI VERDAD???
        ...
        all_candidates.append(cluster)
            ...
            ##CON LOS DE UNO QUE FEM???? LOS QUEREMOS TAMBIEN
